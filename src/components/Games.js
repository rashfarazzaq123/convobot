...
class Games extends React.Component{
    render(){
      ...
      <div className="Games">
        ...
        <p className="gameName1"style={{position:"absolute", top:"130%",left:"55%",color:"#94adb3",fontFamily:"Arial, Helvetica, sans-serif",fontSize:"25px"}}>You can improve your grammar skills from here.<br></br> try this out by clicking play button</p>
        <div className='game2' style={{position:"absolute", top:"175%",left:"53%",width:"600px",heigth:"400px"}}>
        <Link to='/game2'>    
            <img src="vocab.jpg"  width="590" height="300"/>
            <p className="gameName">play</p>
        </Link>
        </div>
        <p className="gameName1"style={{position:"absolute", top:"200%",left:"10%",color:"#94adb3",fontFamily:"Arial, Helvetica, sans-serif",fontSize:"25px"}}>You can improve your vocabulary skills from here.<br></br> try this out by clicking play button</p>
