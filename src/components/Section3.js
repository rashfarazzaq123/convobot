    ...
    render() {
      return (
        <div className="gameIntro">
         ...
         Game for you </h3>
         <h4 style={{float:"right",position:"absolute",top:"278%" ,padding:"5px",left:"26%" ,fontSize:"23px",color:"#819da6"}} >Improve your grammar skills with ths word games! <br></br>Select a games to play!</h4>
